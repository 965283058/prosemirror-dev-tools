...
exports.useNodePicker = useNodePicker;
...
var _expandPath = require("./expand-path");
...
var nodePickerAtom = (0, _jotai.atom)(NODE_PICKER_DEFAULT);

// TODO: rewrite as read and write atom
function useNodePicker() {
  var _useAtom = (0, _jotai.useAtom)(nodePickerAtom),
    _useAtom2 = _slicedToArray(_useAtom, 2),
    nodePickerState = _useAtom2[0],
    setNodePickerState = _useAtom2[1];
  var editorState = (0, _jotai.useAtomValue)(_editorState.editorStateAtom);
  var setExpandPath = (0, _jotai.useSetAtom)(_expandPath.expandPathAtom);
  var api = {
    ...
    select: function select(target) {
      ...
      var node = (0, _findNode.findPMNode)(target);
      if (node) {
