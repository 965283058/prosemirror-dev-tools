/* state.tsx generated by @compiled/babel-plugin v0.17.3 */
"use strict";
...
var _activeMarks = require("../state/active-marks");
var _expandPath = require("../state/expand-path");
var _editorState = require("../state/editor-state");
var _logNodeFromJson = require("../utils/log-node-from-json");
...
var JSONTreeWrapper = function JSONTreeWrapper(_ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_runtime.CC, null, /*#__PURE__*/_react["default"].createElement(_runtime.CS, null, [_, _2, _3, _4, _5, _6]), /*#__PURE__*/_react["default"].createElement("div", {
    className: (0, _runtime.ax)(["_ca0qidpf _u5f3idpf _n3tdrdoj _19bvidpf _1reo15vq _18m915vq"])
  }, children));
};
var Section = function Section(_ref2) {
  var children = _ref2.children;
  return /*#__PURE__*/_react["default"].createElement(_runtime.CC, null, /*#__PURE__*/_react["default"].createElement(_runtime.CS, null, [_7, _8, _9]), /*#__PURE__*/_react["default"].createElement("div", {
    className: (0, _runtime.ax)(["_1ul9mgvx _vchhusvi _129lrdoj"])
  }, children));
};
var Group = function Group(_ref3) {
  var children = _ref3.children;
  return /*#__PURE__*/_react["default"].createElement(_runtime.CC, null, /*#__PURE__*/_react["default"].createElement(_runtime.CS, null, [_10, _11, _12, _13]), /*#__PURE__*/_react["default"].createElement("div", {
    className: (0, _runtime.ax)(["_19pkhage _2hwxidpf _otyrhage _18u01x4e"])
  }, children));
};
var GroupRow = function GroupRow(_ref4) {
  var children = _ref4.children;
  return /*#__PURE__*/_react["default"].createElement(_runtime.CC, null, /*#__PURE__*/_react["default"].createElement(_runtime.CS, null, [_14]), /*#__PURE__*/_react["default"].createElement("div", {
    className: (0, _runtime.ax)(["_ca0qpd1z"])
  }, children));
};
var Key = function Key(_ref5) {
  var children = _ref5.children;
  return /*#__PURE__*/_react["default"].createElement(_runtime.CC, null, /*#__PURE__*/_react["default"].createElement(_runtime.CS, null, [_15, _16, _17, _18, _19, _20]), /*#__PURE__*/_react["default"].createElement("div", {
    className: (0, _runtime.ax)(["_1e0c1o8l _syazx4b6 _19pkidpf _2hwxhage _otyridpf _18u0idpf"])
  }, children));
};
var ValueNum = function ValueNum(_ref6) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_runtime.CC, null, /*#__PURE__*/_react["default"].createElement(_runtime.CS, null, [_21]), /*#__PURE__*/_react["default"].createElement("div", {
    className: (0, _runtime.ax)(["_syazonp9"])
  }, children));
};
var LogNodeButton = function LogNodeButton(_ref7) {
  var children = _ref7.children,
    onClick = _ref7.onClick;
  return /*#__PURE__*/_react["default"].createElement(_runtime.CC, null, /*#__PURE__*/_react["default"].createElement(_runtime.CS, null, [_22, _23, _24, _25, _26, _27, _28, _29, _30, _31, _32]), /*#__PURE__*/_react["default"].createElement("button", {
    "data-test-id": "__prosemirror_devtools_log_node_button__",
    onClick: onClick,
    className: (0, _runtime.ax)(["_syaz4yqd _11q7glyw _19itglyw _v564111k _2rko1l7b _d0altlke _irr31wye _30l35y2n _nt751r31 _49pcglyw _1hvw1o36"])
  }, children));
};
function getItemString(doc, action) {
  return function getItemStringWithBindedDoc(type, value, defaultView, keysCount) {
    ...
    return /*#__PURE__*/_react["default"].createElement("span", null, /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, defaultView, " ", keysCount, " ", logButton));
  };
}
function getItemStringForMark(type, value, defaultView, keysCount) {
  ...
  return /*#__PURE__*/_react["default"].createElement("span", null, /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, defaultView, " ", keysCount));
}
...
var selectionAtom = (0, _jotai.atom)(false);
function StateTab() {
  var _useAtom = (0, _jotai.useAtom)(selectionAtom),
    _useAtom2 = _slicedToArray(_useAtom, 2),
    selectionExpanded = _useAtom2[0],
    setExpanded = _useAtom2[1];
  var activeMarks = (0, _jotai.useAtomValue)(_activeMarks.activeMarksAtom);
  var expandPath = (0, _jotai.useAtomValue)(_expandPath.expandPathAtom);
  var state = (0, _jotai.useAtomValue)(_editorState.editorStateAtom);
  var doc = state === null || state === void 0 ? void 0 : state.doc.toJSON();
  if (!state) return null;
  var logNode = (0, _logNodeFromJson.logNodeFromJSON)(state);
