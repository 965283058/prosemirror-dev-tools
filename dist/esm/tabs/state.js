...
export function getItemString(doc, action) {
  return function getItemStringWithBindedDoc(type, value, defaultView, keysCount) {
    ...
    return /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(React.Fragment, null, defaultView, " ", keysCount, " ", logButton));
  };
}
function getItemStringForMark(type, value, defaultView, keysCount) {
  ...
  return /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(React.Fragment, null, defaultView, " ", keysCount));
}
