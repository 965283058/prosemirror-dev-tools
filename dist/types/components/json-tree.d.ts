...
type GetItemString = (nodeType: string, data: any, itemType: React.ReactNode, itemString: string, keyPath: (string | number)[]) => React.ReactNode | string;
type JSONTreeProps = {
...
export default function JSONTreeWrapper(props: JSONTreeProps): JSX.Element;
export {};
